...
This report tests Evidrift v0.1 as a user would use it: through the CLI, through a real STDIO MCP client, and against temporary repositories with installed local fixture packages.
...
Local checkpoint on 2026-07-15 after the Evidrift rename:
